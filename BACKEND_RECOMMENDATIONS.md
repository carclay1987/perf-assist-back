...
Источник правды по модели данных и LLM‑контексту уже есть в репозитории `perf-assist` (соседний к этому бэкенду), по пути `/Users/inkuroshev/personal/perf-assist/`:

- [`product/02-data-and-llm-design.md`](/Users/inkuroshev/personal/perf-assist/product/02-data-and-llm-design.md:1)
- [`product/03-architecture-and-prompts.md`](/Users/inkuroshev/personal/perf-assist/product/03-architecture-and-prompts.md:1)
...
В [`product/03-architecture-and-prompts.md`](/Users/inkuroshev/personal/perf-assist/product/03-architecture-and-prompts.md:1) стоит явно зафиксировать:
...
- Собирает данные из БД в структуры, соответствующие описанию в [`product/02-data-and-llm-design.md`](/Users/inkuroshev/personal/perf-assist/product/02-data-and-llm-design.md:1).
...
- Общую продуктовую спецификацию (`product/*`) в репозитории `perf-assist`.
